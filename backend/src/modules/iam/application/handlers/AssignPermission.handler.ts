...
import { AssignPermissionCommand } from '../commands/AssignPermission.command';
...
export class AssignPermissionHandler implements ICommandHandler<AssignPermissionCommand> {
  constructor(
