/**
 * Global chart color palette — mirrors frontend/src/utils/chartColors.ts (SERIES_COLORS).
 *
 * 100 distinct colors for series rotation, INTERLEAVED across 10 hue families
 * (Blue, Green, Amber, Red, Purple, Cyan, Orange, Pink, Teal, Indigo) so that
 * consecutive series indices are always visually distinct.
 *
